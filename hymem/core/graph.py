...
def live_edge_predicate(
    ...
    *,
    ...
    parts.extend([
        ...
        f"AND hymem_out.phase1_generation_key IS NOT NULL "
        f"AND hymem_out.phase1_generation_key="
        f"hymem_obs.phase1_generation_key "
        f"JOIN phase1_generations hymem_generation "
        f"ON hymem_generation.generation_key="
        f"hymem_out.phase1_generation_key "
        f"AND hymem_generation.extraction_cache_key="
        f"hymem_out.prompt_version "
        ...
        f"AND hymem_phase1_generation_is_current("
        f"hymem_generation.generation_key,"
        f"hymem_generation.identity_exact)=1 "
