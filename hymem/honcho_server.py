...
def _build() -> HyMem:
    ...
    return HyMem(HyMemConfig(root=root), llm=OpenAICompatibleClient())
...
def add_messages(
    ...
    for m in body.messages:
        ...
        msg_id = _hy.log_message(session_id, role, m.content)
